(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.filter.js'), require('core-js/modules/es.array.find.js'), require('core-js/modules/es.array.flat.js'), require('core-js/modules/es.array.for-each.js'), require('core-js/modules/es.array.includes.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.unscopables.flat.js'), require('core-js/modules/es.function.name.js'), require('core-js/modules/es.object.keys.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.object.values.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.includes.js'), require('core-js/modules/es.string.split.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('vue')) :
  typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.filter.js', 'core-js/modules/es.array.find.js', 'core-js/modules/es.array.flat.js', 'core-js/modules/es.array.for-each.js', 'core-js/modules/es.array.includes.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.unscopables.flat.js', 'core-js/modules/es.function.name.js', 'core-js/modules/es.object.keys.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.object.values.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.includes.js', 'core-js/modules/es.string.split.js', 'core-js/modules/web.dom-collections.for-each.js', 'vue'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.core = {}, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, global.Vue));
}(this, (function (exports, es_array_filter_js, es_array_find_js, es_array_flat_js, es_array_forEach_js, es_array_includes_js, es_array_join_js, es_array_map_js, es_array_unscopables_flat_js, es_function_name_js, es_object_keys_js, es_object_toString_js, es_object_values_js, es_promise_js, es_regexp_exec_js, es_string_includes_js, es_string_split_js, web_domCollections_forEach_js, Vue) { 'use strict';
  ...
  var InputField = /*#__PURE__*/function () {
    ...
    _createClass(InputField, [{
      ...
      value: function deleteError(trigger) {
        Vue__default['default'].delete(this._errors, trigger);
      }
    }, {
      key: "validate",
      value: function () {
      ...
      set: function set(errors) {
        ...
        errorToRemove.forEach(function (fn) {
          Vue__default['default'].delete(_this4._errors, fn);
        });
        errorToAdd.forEach(function (err) {
          Vue__default['default'].set(_this4._errors, err.fn, err.error);
        });
      },
      get: function get() {
